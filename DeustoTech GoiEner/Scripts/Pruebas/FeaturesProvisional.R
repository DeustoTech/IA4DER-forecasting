...
model_names <- c("Media", "Naive", "SNaive", "Arima", "ETS", "NN")
...
# Listar los nombres de los otros archivos CSV
file_names <- c("Resultados/CUPS/SummaryPreds.csv",
                "Resultados/CUPS/SummaryMedia.csv",
                "Resultados/CUPS/SummaryNaive.csv",
                "Resultados/CUPS/SummarySNaive.csv",
                "Resultados/CUPS/SummaryArima.csv",
                "Resultados/CUPS/SummaryETS.csv",
